...
public class TestStatisticsPage extends LogInOutBase{
    ...
    public void switchBetweenStatisticsScopes() throws InterruptedException {
        ...
        String newUrl1;
        do {
            newUrl1 = WebDriverContainer.getDriver().getCurrentUrl();
            Thread.sleep(5);
        ...
        String newUrl2;
        do {
            newUrl2 = WebDriverContainer.getDriver().getCurrentUrl();
            Thread.sleep(5);
        ...
        String newUrl3;
        do {
            newUrl3 = WebDriverContainer.getDriver().getCurrentUrl();
            Thread.sleep(5);
